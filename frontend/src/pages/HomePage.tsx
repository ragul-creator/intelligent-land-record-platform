...
export function HomePage() {
  ...
  return <main className="home-shell">
    {!loggedIn && <EarthBackground />}
    {!loggedIn && <header className="home-hero">
      <div>
        <p className="eyebrow">AI · GIS · Human Verification · Immutable Provenance</p>
        <h1>Intelligent Land Record Platform</h1>
        <p>One auditable workflow for digitized land records, human verification, cadastral GIS, and evidence-backed record-to-parcel association.</p>
      </div>
      
    </header>}

    {!loggedIn && <section className="login-card" aria-label="Sign in">
      <div><p className="eyebrow">AI · GIS · Human Verification · Immutable Provenance</p><h2>Sign in</h2><p>Use an authorized application login ID to access your project workspace.</p></div>
    ...
    {loggedIn && <>
      ...
      {canCreateProject && <section className="project-create-card" aria-label="Create project">
        <div><p className="eyebrow">AI · GIS · Human Verification · Immutable Provenance</p><h2>Create a project</h2><p>Creates an isolated ACTIVE project and adds you as its owner/member using your current application role.</p></div>
      ...
      <section className="project-launcher">
        <div className="project-launcher-heading"><div><p className="eyebrow">AI · GIS · Human Verification · Immutable Provenance</p><h2>Choose a project workspace</h2></div><span>{projects.data?.items.length ?? 0} active</span></div>
      ...
      <section className="home-demo-path">
        <div><p className="eyebrow">AI · GIS · Human Verification · Immutable Provenance</p><h2>Show the vertical slice in four moves</h2></div>
        <ol>
